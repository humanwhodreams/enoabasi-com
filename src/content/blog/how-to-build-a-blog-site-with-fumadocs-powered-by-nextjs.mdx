...
Building a blog has never been easy, there is so much that goes into creating and managing a blog. As developer, with the new era of software at your finger tips building a blog has become so easy, like taking candy from a baby. In this blog, I am going to walk you through the process of how to build a blog site with Fumadocs powered by Next.js.
...
It is recommend to start a new Next.js application using `create-next-app`, which sets up everything automatically for you. To create a project, run:
